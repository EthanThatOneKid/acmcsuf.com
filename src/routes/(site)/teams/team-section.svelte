<script lang="ts">
  ...
  const nodebudsTerms = [Term.Fall21, Term.Spring21, Term.Spring22, Term.Fall24, Term.Spring25];
  const gamedevTerms = [Term.Spring23, Term.Fall23, Term.Spring24, Term.Fall24, Term.Spring25];
  $: skip =
