<script lang="ts">
  ...
  export let reducedMotionSrc: string;
  export let altSrc: string;
</script>

<img class="reduced-motion" src={reducedMotionSrc} alt={altSrc} />

<svg
  class="non-reduced-motion"
...
>
  ...
  <image clip-path="url(#shape2)" xlink:href={src} />
</svg>
