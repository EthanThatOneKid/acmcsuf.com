...
export default [
  {
    ...
    directors: [{name: 'Jacob Nguyen', picture: '/people/jacob-nguyen.webp'}, {name: 'Samuel Sandoval', picture: '/people/samuel-sandoval.webp'}]
  },
  {
    id: 'tuffyhacks2022',
  ...
  },
  {
    ...
    directors: [{name: 'Daniel Truong', picture: '/people/daniel-truong.webp'}, {name: 'David Solano', picture: '/people/david-solano.webp'}]
  },
