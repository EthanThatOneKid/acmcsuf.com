  ...
  "2020-2021": [
    {
      ...
      positions: [{ rank: "Director", faction: "create" }]
    },
    {
      name: "Aaron Lieberman",
      title: "Internal Vice President 😎",
      picture: "aaron-lieberman.jpg",
      positions: [{ rank: "Officer", faction: "node-buds" }]
    },
    {
      name: "Samuel Sandoval",
      picture: "samuel-sandoval.jpg",
      positions: [{ rank: "Director", faction: "dev" }]
    },
    {
      name: "Ethan Davidson",
      title: "Webmaster 👨‍💻",
