  ...
  questions: [
    {
      ...
      choices: [
        {
          content:
            "Leverage algorithms and competitive programming to solve complex problems.",
    ...
    {
      prompt:
        "If you could choose one programming language, which would you choose?",
      choices: [
        {
          content: "JavaScript",
    ...
    {
      prompt:
        "If you got a job offer from these companies below, which one will you accept?",
      choices: [
        {
          content: "Google",
          match: [TeamMatch.AI],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          content:
            "Say “Damn that sucks” and keep working on making your project beautiful",
          match: [TeamMatch.DESIGN, TeamMatch.GAMEDEV],
        },
        {
          content:
