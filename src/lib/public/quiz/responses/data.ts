...
export const REPORTS: Record<
  Exclude<TeamMatch, TeamMatch.TEAMLESS>,
  TeamReport
> = {
  [TeamMatch.AI]: {
    blurb:
    ...
    blurbRecommend:
      "Check out #🦾ai-resources in our Discord server for more resources.",
  ...
  [TeamMatch.DEV]: {
    ...
    blurbRecommend:
      "Check out #🌐dev-resources in our Discord server for more resources.",
  ...
  [TeamMatch.DESIGN]: {
    ...
    blurbRecommend:
      "Check out #🎨design-resources in our Discord server for more resources.",
  ...
  [TeamMatch.ALGO]: {
    ...
    blurbRecommend:
      "Check out #📑algo-resources in our Discord server for more resources.",
  ...
  [TeamMatch.GAMEDEV]: {
    ...
    blurbRecommend:
      "Check out #🖇gamedev-resources in our Discord server for more resources.",
  ...
  [TeamMatch.ICPC]: {
    ...
    blurbRecommend:
      "Check out #💪icpc-resources in our Discord server for more resources.",
